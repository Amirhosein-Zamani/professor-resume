export function buildPublicationReport1304PubXml(): string {
  return `
<Root>
...
export function buildPublicationReport1304PriXml(): string {
  return `
<Root>
...
export function buildPublicationReport1304MorXml(): string {
  return '';
}
